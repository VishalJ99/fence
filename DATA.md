...
- `Tab/` — PER-414/PER-416 standalone macOS notch companion: frozen eyes plus an opt-in local ScreenCaptureKit/Vision context log and optional metadata-first Luna adapter, under an independent bundle identity and permission surface.
