...
3. Give Tab its own sandbox and entitlements file. The eyes milestone enables only the App Sandbox. Screen Recording, network, microphone, Accessibility, Automation, keychain-group, or other capabilities require separately tracked milestones.
...
The user approved the three-tier UI and asked that it be frozen on 2026-08-01.
