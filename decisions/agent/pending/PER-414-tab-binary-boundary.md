...
6. Use chibi concern cues rather than punitive alarm cues: high-contrast raised-inner brows for mild concern; the same full-length grey brows rotating inner-down, smaller pupils, a brief wiggle, and a coral anger hatch made from four separate inward-bowing curves for very concerned. The neutral and mild panel remains 44 x 20 points. Very concerned alone adds a minimal robust 8-point gutter on the right, anchored so the eyes do not move, yielding 52 x 20 points and keeping the hatch visibly separate from the eye at the wiggle's maximum displacement. Red is reserved for the high-heat accent rather than the brows. A persistent exclamation mark is excluded because it reads as a system alert. The default launch remains neutral.
