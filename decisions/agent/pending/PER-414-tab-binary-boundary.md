...
6. Use chibi concern cues rather than punitive alarm cues: soft raised-inner brows for mild concern; the same grey brows rotating inner-down, smaller pupils, a brief wiggle, and a tiny coral four-lobed stress-vein mark for very concerned. Red is reserved for the small high-heat accent rather than the brows. A persistent exclamation mark is excluded because it reads as a system alert. The default launch remains neutral.
